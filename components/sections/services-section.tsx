    ...
    <div className="py-32 px-4" id="services" ref={sectionRef}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-8">
          <div className={cn(
            "md:col-span-6 lg:col-span-5 bg-white p-10 rounded-xl shadow-xl shadow-[#569196]/10 relative overflow-hidden group",
            isVisible && "opacity-100 transform-none"
          )}>
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#569196] to-[#7abebc]" />
            <Camera className="w-12 h-12 text-[#569196] mb-8" />
            ...
            <Button variant="ghost" className="text-[#569196] group-hover:text-[#45767a]">
              Learn more <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-[#569196]/5 rounded-full opacity-50 group-hover:scale-150 transition-all duration-500" />
          </div>

          <div className={cn(
            "md:col-span-6 lg:col-span-7 bg-white p-10 rounded-xl shadow-xl shadow-[#569196]/10 relative overflow-hidden group",
            isVisible && "opacity-100 transform-none"
          )}>
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#569196] to-[#7abebc]" />
            <Play className="w-12 h-12 text-[#569196] mb-8" />
          ...
          <div className={cn(
            "md:col-span-12 bg-white p-10 rounded-xl shadow-xl shadow-[#569196]/10 relative overflow-hidden group",
            isVisible && "opacity-100 transform-none"
          )}>
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#569196] to-[#7abebc]" />
            <div className="md:flex items-center gap-8">
              <div className="md:w-1/2 mb-6 md:mb-0">
                <Image className="w-12 h-12 text-[#569196] mb-8" />
